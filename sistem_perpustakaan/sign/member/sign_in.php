...
<!DOCTYPE html>
  ...
  <div class="container">
    <div class="card p-2 mt-5">
      ...
      <h1 class="pt-5 text-center fw-bold">LOGIN SISWA</h1>
      <hr>
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit" name="signIn">Masuk</button>
    <a class="btn btn-success" href="../link_login.html">Batal</a>
  </div>
  <p>Belum Memiliki akun ? <a href="sign_up.php" class="text-decoration-none text-primary">Sign Up</a></p>
</form>
</div>
<?php if(isset($error)) : ?>
